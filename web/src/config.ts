...
export const PROTOCOL_CONFIG = {
  [Number(sepolia.id)]: {
    domain: {
      // (yinxing)DONE1: 配置EIP-712签名域名信息
      name: 'RenftMarket',
      version: '1', 
      chainId: 11155111,
      verifyingContract: '0xf2167De4aF0A16e8818b0d844596Bf95C4847C4f',
    },
    rentoutMarket: "0xf2167De4aF0A16e8818b0d844596Bf95C4847C4f", // (yinxing)DONE: 配置出租市场合约地址
  },
} as const;
